...
export default function TransactionForm({
  ...
  return (
    <div className="fixed inset-0 z-[110] flex items-end justify-center bg-black/70 backdrop-blur-sm sm:items-center sm:p-4">
      <div
        className="w-full max-w-lg overflow-hidden rounded-t-[2.5rem] shadow-2xl sm:rounded-[2.5rem]"
          ...
          >
            <button
              ...
              className={`flex-1 rounded-xl py-4 font-black transition-all ${
                type === 'expense' ? 'bg-red-500 text-white shadow-lg' : 'text-gray-400 hover:text-white'
              }`}
            >
              {t.expense}
            </button>
            <button
              ...
              className={`flex-1 rounded-xl py-4 font-black transition-all ${
                type === 'income' ? 'bg-green-500 text-white shadow-lg' : 'text-gray-400 hover:text-white'
              }`}
            >
              {t.income}
            </button>
